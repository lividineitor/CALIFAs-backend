...
public class V1JuegosBody   {
  ...
  public V1JuegosBody usuarioId1(Integer usuarioId1) {
   ...
   * @return usuarioId1
   **/
  @Schema(example = "1234", required = true, description = "El id del usuario 1.")
      @NotNull
  ...
  public V1JuegosBody usuarioId2(Integer usuarioId2) {
   ...
   * @return usuarioId2
   **/
  @Schema(example = "2345", required = true, description = "El id del usuario 2.")
      @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1JuegosBody v1JuegosBody = (V1JuegosBody) o;
    return Objects.equals(this.usuarioId1, v1JuegosBody.usuarioId1) &&
        Objects.equals(this.usuarioId2, v1JuegosBody.usuarioId2);
  }
